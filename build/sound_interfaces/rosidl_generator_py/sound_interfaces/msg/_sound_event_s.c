...
bool sound_interfaces__msg__sound_event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sound_interfaces.msg._sound_event.SoundEvent", full_classname_dest, 44) == 0);
  }
  sound_interfaces__msg__SoundEvent * ros_message = _ros_message;
  {  // header
...
PyObject * sound_interfaces__msg__sound_event__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sound_interfaces.msg._sound_event");

...
static const _SoundEvent_type_support_symbol_names_t _SoundEvent_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sound_interfaces, msg, SoundEvent)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sound_interfaces, msg, SoundEvent)),
  }
};
...
{
  return &::sound_interfaces::msg::rosidl_typesupport_cpp::SoundEvent_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sound_interfaces, msg, SoundEvent)() {
  return get_message_type_support_handle<sound_interfaces::msg::SoundEvent>();
}
